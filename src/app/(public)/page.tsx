            ...
            return (
              ...
              >
                ...
                <div className="md:hidden flex-1 min-w-0">
                  <TierCard tier={tier} align="left" />
                  <span
                    className="inline-block text-[10px] font-semibold tracking-widest uppercase px-2 py-0.5 rounded-full mt-1.5"
...
function TierCard({ tier, align }: { tier: typeof TIERS[number]; align: 'left' | 'right' }) {
  return (
    <div className={align === 'right' ? 'text-right' : 'text-left'}>
      <div className="text-[10px] tracking-widest uppercase font-semibold mb-0.5" style={{ color: tier.color }}>
        Tầng {tier.n}
      </div>
