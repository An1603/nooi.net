                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border/10">
                        <th className="text-left px-4 py-2 text-[10px] font-medium text-muted-foreground">ID</th>
                        <th className="text-left px-4 py-2 text-[10px] font-medium text-muted-foreground">Tiêu đề</th>
                        <th className="text-center px-4 py-2 text-[10px] font-medium text-muted-foreground hidden sm:table-cell">Loại</th>
                        <th className="text-center px-4 py-2 text-[10px] font-medium text-muted-foreground hidden md:table-cell">TG</th>
                        <th className="text-center px-4 py-2 text-[10px] font-medium text-muted-foreground hidden lg:table-cell">YouTube</th>
                        <th className="text-center px-4 py-2 text-[10px] font-medium text-muted-foreground hidden xl:table-cell">Thứ tự</th>
                        <th className="text-center px-4 py-2 text-[10px] font-medium text-muted-foreground hidden lg:table-cell">Học viên</th>
                        <th className="text-center px-4 py-2 text-[10px] font-medium text-muted-foreground">Trạng thái</th>
                        <th className="text-right px-4 py-2 text-[10px] font-medium text-muted-foreground">Hành động</th>
                      </tr>
                    </thead>
                      ...
                      {level.lessons.map((lesson) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-2.5 text-center hidden sm:table-cell">
                            <span className={`text-[10px] px-1.5 py-0.5 rounded ${typeBadge(lesson.type)}`}>
                          ...
                          <td className="px-4 py-2.5 text-center hidden lg:table-cell">
                            {lesson.youtube_id ? (
                              <span className="text-[10px] font-mono text-blue-400 truncate inline-block max-w-[100px]">
                                {lesson.youtube_id}
                              </span>
                            ) : (
          ...
          <form onSubmit={handleCreate} className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                required
              />
              <p className="text-[9px] text-muted-foreground">Mã định danh duy nhất, VD: 1-6, 2-5</p>
            </div>
            ...
            {createForm.type === "video" && (
              <div className="space-y-1">
                ...
                <Input
                  ...
                  className="h-9 text-sm"
                />
                <p className="text-[9px] text-muted-foreground">Phần ID sau v= trong URL YouTube</p>
              </div>
            )}
