                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {!u.onboarding_completed && (
                            <span className="text-[12px] px-1.5 py-0.5 rounded bg-amber-500/10 text-amber-400">Chưa setup</span>
                          )}
                        </div>
                        <p className="text-[12px] text-muted-foreground">{u.email || u.id.slice(0, 12)}...</p>
                      </div>
                    </div>
