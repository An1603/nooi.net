    ...
    <div className="rounded-xl border border-border bg-card p-5">
      ...
      {loading ? (
        ...
        <div className="text-center py-8">
          ...
          <p className="text-[12px] text-muted-foreground/60 mt-1">Tham gia nhóm để thi đua cùng bạn bè</p>
        </div>
      ) : scores.length === 0 ? (
        <div className="text-center py-8">
          ...
          {scores.map((s) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 flex-1 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-medium truncate">
                    {s.name}
                    {s.user_id === myUserId && <span className="text-[12px] text-primary ml-1">(Bạn)</span>}
                  </p>
              ...
              <div className="text-right">
                ...
                <p className="text-[12px] text-muted-foreground">điểm</p>
              </div>
            </div>
          ))}
        </div>
