                  ...
                  return (
                    <tr key={vid.id} className="hover:bg-white/[0.01]">
                      <td className="px-5 py-3">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div className="min-w-0">
                            ...
                            {vid.description && <p className="text-[12px] text-muted-foreground truncate max-w-[200px]">{vid.description}</p>}
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-5 py-3 text-center hidden sm:table-cell">
                        <span className={`text-[12px] px-1.5 py-0.5 rounded font-medium ${statusColors[vid.status || ""] || "bg-muted/30 text-muted-foreground"}`}>
                          {vid.status || "unknown"}
                        </span>
                      </td>
