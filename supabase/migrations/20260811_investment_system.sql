-- Migration: Investment System for NOOI Project Management
-- Date: 2026-08-11
...
COMMENT ON TABLE public.investments IS 'Quản lý đăng ký đầu tư vào dự án NOOI';
COMMENT ON COLUMN public.investments.payment_status IS 'Trạng thái thanh toán: pending, paid, cancelled, failed';
COMMENT ON COLUMN public.investments.payment_method IS 'Phương thức: bank_transfer, credit_card, crypto, cash';
...
COMMENT ON TABLE public.project_progress IS 'Lịch sử tiến độ từng giai đoạn của dự án';
COMMENT ON COLUMN public.project_progress.milestones_completed IS 'Các milestone đã hoàn thành: ["milestone1", "milestone2"]';
...
-- ===========================
-- 7. Sample data (dành cho testing)
-- ===========================
-- Không insert sample data vào production
-- Chỉ dùng để test schema

-- ===========================
-- 8. View aggregates (cơ sở cho dashboard)
-- ===========================
