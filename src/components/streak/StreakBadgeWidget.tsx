        ...
        <div className="flex items-center justify-between mb-4 relative">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground">Duy trì mỗi ngày để nhận thưởng</p>
            </div>
          </div>
        ...
        {earned.length > 0 && (
          <div className="pt-3 border-t border-border/30">
            <div className="flex items-center justify-between mb-2">
              ...
              <Link href="/app/kho-vat-pham" className="text-[10px] text-primary hover:underline flex items-center gap-0.5">
