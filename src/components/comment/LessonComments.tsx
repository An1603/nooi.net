          ...
          <div className="flex items-center gap-3 mt-1.5">
            ...
            {!isReply && (
              <button
                ...
                className="flex items-center gap-1 text-[12px] text-muted-foreground/50 hover:text-primary transition-colors"
              >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-1">
          <button
            ...
            className={`text-[12px] px-2 py-1 rounded-lg transition-colors ${sortBy === "newest" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-muted/20"}`}
          >
            Mới nhất
          </button>
          <button
            onClick={() => setSortBy("popular")}
            className={`text-[12px] px-2 py-1 rounded-lg transition-colors ${sortBy === "popular" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-muted/20"}`}
          >
            Yêu thích
          </button>
        </div>
