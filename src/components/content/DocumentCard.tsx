    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-[11px] text-muted-foreground uppercase tracking-wider">{type.label}</span>
        </div>
        ...
        {/* Category */}
        {parsed.category && (
          <span className="inline-block text-[11px] px-2 py-0.5 rounded-full bg-primary/10 text-primary mt-2">
            {parsed.category}
          </span>
        )}
        ...
        {file_type === "audio" && parsed.url && (
          <div className="mt-2 flex items-center gap-2 text-[11px] text-muted-foreground bg-muted/30 rounded-lg px-3 py-2">
        ...
        {/* PDF badge */}
        {file_type === "pdf" && (
          <div className="mt-2 flex items-center gap-2 text-[11px] text-muted-foreground bg-orange-500/10 rounded-lg px-3 py-2">
