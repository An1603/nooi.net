...
export function Sidebar() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex w-52 shrink-0 min-h-screen border-r border-border bg-card flex-col relative">
      ...
      {mobileOpen && (
        <>
          <div
            ...
            onClick={() => setMobileOpen(false)}
          />
          <aside className="lg:hidden fixed inset-y-0 left-0 z-50 w-64 bg-card border-r border-border flex flex-col shadow-2xl animate-slide-up">
