                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    {unlocked && level.lessons.length > 0 && (
                      <span className="text-[12px] text-muted-foreground">{levelDone}/{level.lessons.length} ({levelPct}%)</span>
                    )}
                  </div>
                        ...
                        {accessible ? (
                          <Link href={`/app/hoc-tap/${lesson.id}`} className="flex items-center gap-3 px-5 py-3 hover:bg-muted/20 transition-colors">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2">
                                ...
                                {p.pct > 0 && <span className="text-[12px] text-muted-foreground shrink-0">{p.pct}%</span>}
                              </div>
                              <p className="text-[12px] text-muted-foreground">{lesson.duration} · {lesson.type === "video" ? "Video" : "Thực hành"}</p>
                            </div>
                          ...
                          <div className="flex items-center gap-3 px-5 py-3 cursor-not-allowed">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-[12px] text-muted-foreground">Cần hoàn thành bài trước</p>
                            </div>
                            {lesson.free && <span className="text-[12px] text-primary">Free</span>}
                          </div>
                        )}
                      </div>
                    );
