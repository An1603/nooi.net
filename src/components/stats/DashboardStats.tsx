        ...
        <LevelInfoModal
          ...
          trigger={
            <div className="rounded-xl border border-border bg-card p-4 text-center cursor-pointer hover:border-primary/30 hover:bg-card/80 transition-all">
              ...
              <p className="text-[12px] text-primary mt-0.5">{stats.levelName}</p>
            </div>
          }
        />
      </div>
          ...
          {[
            ...
            return (
              <div key={b.level} className={`flex flex-col items-center gap-1.5 p-2 rounded-xl transition-all ${
                ...
                <span className={`text-[12px] font-medium ${unlocked ? "text-foreground" : "text-muted-foreground"}`}>
                  {b.name}
                </span>
                <span className="text-[12px] text-muted-foreground">{b.threshold}N</span>
              </div>
            );
          })}
        </div>
